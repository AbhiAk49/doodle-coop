  ...
  computed: {
    nameErrors() {
      ...
      !this.$v.form.name.maxLength &&
        errors.push('Name cannot exceed 18 characters');
    ...
    passwordErrors() {
      ...
      !this.$v.form.password.containsUppercase &&
        errors.push('Password should contain atleast 1 uppercase');
      !this.$v.form.password.containsLowercase &&
        errors.push('Password should contain atleast 1 lowercase');
      !this.$v.form.password.containsNumber &&
        errors.push('Password should contain atleast 1 number');
      !this.$v.form.password.containsSpecial &&
        errors.push('Password should contain atleast 1 special character');
      return errors;
    },
    confirmPasswordErrors() {
      ...
      !this.$v.form.confirmPassword.sameAsPassword &&
        errors.push('Should be same as password');
      return errors;
    },
  },
